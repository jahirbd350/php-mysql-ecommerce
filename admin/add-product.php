                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="product_code" name="product_code" class="form-control"  placeholder="Sub Category Description"/>
                                        <span></span>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="product_brand" name="product_brand" class="form-control"  placeholder="Sub Category Description"/>
                                        <span></span>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                ...
                                <div class="form-group row mb-4">
                                    <label for="product_size" class="col-sm-3 col-form-label">Product Size</label>
                                    <div class="col-sm-9">
